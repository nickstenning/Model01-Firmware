...
KEYMAPS(
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_ScrollLock,Key_6, Key_7, Key_8,     Key_9,         Key_0,         LockLayer(NUMPAD),
   Key_Enter,     Key_Y, Key_U, Key_I,     Key_O,         Key_P,         Key_Equals,
                  Key_H, Key_J, Key_K,     Key_L,         Key_Semicolon, Key_Quote,
   Key_RightAlt,  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, Key_RightControl,
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_LEDEffectPrevious,
   ...
   M(MACRO_CTRL_ALT_BREAK), Key_Delete, ___, ___,
   ___,
   ...
   ___, ___, Key_Enter, M(MACRO_CTRL_ALT_BREAK),
   ___)
) // KEYMAPS(
...
const macro_t *macroAction(uint8_t macroIndex, uint8_t keyState) {
  ...
  case MACRO_CTRL_ALT_BREAK:
    return MACRODOWN(D(LeftControl),D(LeftAlt),T(Pause),U(LeftAlt),U(LeftControl));
    break;
  }
  return MACRO_NONE;
}
